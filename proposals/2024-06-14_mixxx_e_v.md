...
6. Der Ausschluss eines Mitglieds kann von der Mitgliederversammlung oder durch
   ...
   * b) Nichtbezahlen von Mitgliedsbeiträgen über einen Zeitraum von 12 Monaten.
   Dem Mitglied muss vor dem Ausschluss eine Zweiwochenfrist eingeräumt werden,
...
2. Sie findet mindestens einmal im Jahr statt, wobei die Einladungen mindestens
   ...
   Kernmitglieder und außerordentlichen Mitglieder schriftlich per Post oder 
   Email versendet werden muss. Die Mitglieder können dem Vorstand bis zwei 
   Wochen vor der Versammlung zusätzliche Tagesordnungspunkte einreichen. Der 
   Vorstand veröffentlicht die endgültige Tagesordnung online.
...
2. It takes place at least once a year, with invitations including a
   preliminary agenda is sent in writing by post or email to all core and
   extraordinary members at least six weeks prior. The members may submit
   additional agenda items to the board until two weeks before the assembly.
   The Board will publish the final agenda online.
